...
void usbuart_init(void)
{
	...
	gpio_mode_setup(GPIOA, GPIO_OSPEED_2MHZ, GPIO_PUPD_PULLUP, GPIO9);
	gpio_mode_setup(GPIOA, GPIO_OSPEED_2MHZ, GPIO_PUPD_PULLUP, GPIO2);
	gpio_mode_setup(GPIOB, GPIO_OSPEED_2MHZ, GPIO_PUPD_PULLUP, GPIO10);
